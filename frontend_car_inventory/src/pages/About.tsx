    ...
    return (
      ...
      >
        <div className="grid grid-cols-1  place-items-center h-screen">
          ...
          <p className="p-5 m-3 bg-slate-300 bg-opacity-50 text-black rounded">This is the Car Inventory Site. You are able to enter cars and search for them on the site. Head over to the <a href="./dashboard">Dashboard</a> and get started creating your Cars.</p>
        </div>
